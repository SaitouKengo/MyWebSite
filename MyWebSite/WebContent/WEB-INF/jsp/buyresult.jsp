...
<body background="picture/p0526_m.jpg">
	...
	<div class="container">
		...
		<h2 class="text-center">購入が完了しました</h2>

		<br> 購入日時 2018年02月28日18時13分 <br><br>
		著者 東村博之　　　書籍名 不敵な思考 <br><br>
		著者 東村博之　　　書籍名 4chanまでも捨てた理由
		<br><br>
		<div class="button_center">
			<a class="btn btn-primary" href="userList.html">TOP画面に戻る</a>
